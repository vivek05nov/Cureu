            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-12">
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('hospital');?>">Home</a></li>
                    ...
                    <div class="profile-sidebar">
                        <div class="widget-profile pro-widget-content">
                            <div class="profile-info-widget">
                                <a href="<?php echo base_url('hospital/index')?>" class="booking-doc-img">
                                    <img src="<?php echo base_url()?>assets/img/hospital/<?php echo $user->image; ?>" alt="User Image" onerror="this.onerror=null; this.src='http://cureu.in/assets/img/doctors/123.png'">
                                </a>
						...
						<?php if($this->uri->segment(2)=='index')
								...
								else if($this->uri->segment(2)=='view_hos_ehr')
								{
									
									$view_hos_ehr="class='active'";
								}
								else if($this->uri->segment(2)=='hotel')
								{
									
									$hotel="class='active'";
								}
								else if($this->uri->segment(2)=='pharmacy')
								{
									
									$pharmacy="class='active'";
								}
                            ...
                            <nav class="dashboard-menu">
                                <ul>
                                    <li <?php  if(isset($dashboard)){ echo $dashboard;}?>>
                                        <a href="<?php echo base_url('hospital/index');?>">
                                            <i class="fas fa-columns"></i>
                                            <span>Dashboard</span>
                                        </a>
                                    </li>
                                    <li <?php  if(isset($appointment)){ echo $appointment;}?>>
                                        <a href="<?php echo base_url('hospital/appointment') ?>">
									...
									<li <?php  if(isset($view_hos_ehr)){ echo $view_hos_ehr;}?>>
                                        <a href="<?php echo base_url('hospital/view_hos_ehr') ?>">
                                    ...
                                    <li <?php  //if(isset($dashboard)){ echo $dashboard;}?>>
                                     ...
                                     <li <?php  if(isset($hotel)){ echo $hotel;}?>>
                                        <a href="<?php echo base_url() ?>hospital/hotel">
                                            <i class="fas fa-star"></i>
                                            <span>Hotel</span>
                                        </a>
                                    </li>
                                    <li <?php  if(isset($pharmacy)){ echo $pharmacy;}?>>
									...
									<li <?php  if(isset($view_profile)){ echo $view_profile;}?>>
                                        <a href="<?php echo base_url('hospital/view_profile') ?>">
                                            <i class="fas fa-user-cog"></i>
                                            <span>Profile</span>
                                        </a>
                                    </li>
                                    <li <?php  if(isset($change_password)){ echo $change_password;}?>>
                                        <a href="<?php echo base_url('hospital/change_password') ?>">
                                            <i class="fas fa-lock"></i>
                                            <span>Change Password</span>
                                        </a>
                                    </li>
                                    <li <?php  //if(isset($logout)){ echo $logout;}?>>
