					...
					<div class="card">
								<div class="card-body">
						<?php echo form_open_multipart('doctors/refer_hospital');?>
							<!-- Basic Information -->
									...
									<div class="row form-row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<?php $id =$this->db->query('SELECT members.name as members,members.id as members_id from appointment 
																			join doctors on doctors.id=appointment.doctor_id
																			join members on members.id=appointment.member_id
																			where appointment.id="'.$this->uri->segment(3).'"')->row();
																			
												?>
												<input type="hidden" name="hidden_doc" value="<?php  echo $this->session->userdata('userid') ;?>">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Doctor Refer <span class="text-danger">*</span></label>
												<input type="text" value="<?php echo  strtoupper($user->name); ?>" class="form-control" name="Doc_refer"  readonly>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>About Patient <span class="text-danger">*</span></label>
												<textarea type="text" class="form-control" row="4" name="about_patient">
												</textarea>
											</div>
										</div>
										</div>
