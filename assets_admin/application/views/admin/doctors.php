												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="<?php echo base_url(); ?>assets/img/doctors/<?php echo $row->image ?>" onerror="this.onerror=null; this.src='<?php echo base_url('assets/img/doctors/123.png') ?>'" alt="User Image"></a>
													...
													<div class="actions">
															...
															<a data-id="<?php  echo $row->id?>" class="modall  btn btn-sm bg-info-light">
																<i class="fe fe-eye"></i> 
															</a>
														</div>
													</td>
		...
		<div class="modal-dialog modal-dialog-centered" role="document" >
			...
			<!--	<div class="modal-header">
				...
				<div class="modal-body">
					...
					<form method="post" action="<?php echo base_url('admin/delete_doctors'); ?>">
