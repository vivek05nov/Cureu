								...
								<div class="card">
									...
									<div class="card-body">
										<?php echo form_open_multipart('admin/add_blog');?>
											...
											<div class="form-group">
												<label>About</label>
												<textarea class="form-control" name="blog_description" required="" style="height: 150px;"></textarea>
												<script>
											...
											<?php $sr = 1; 
												...
												<tr>
													...
													<td>
															...
															<a href="#"  >
																<img class="avatar-img"  src="<?php echo base_url(); ?>assets/img/blog/<?php echo $row->blog_image ?>" alt="Banner" style="width:200px ;height:100px">
															</a>
													...
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light"  href="<?php echo base_url('Admin/Edit_blog/').$row->id;?>">
														...
														<div class="modal-dialog modal-dialog-centered" role="document" >
															...
															<!--	<div class="modal-header">
																...
																<div class="modal-body">
																	...
																	<form method="post" action="<?php echo base_url('admin/delete_blog'); ?>">
