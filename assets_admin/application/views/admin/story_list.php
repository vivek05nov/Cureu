...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Stories</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url('admin/index'); ?>">Dashboard</a></li>
									<li class="breadcrumb-item"><a href="javascript:(0)">Stories</a></li>
                                ...
                                <?php } ?></td>
													...
													<td class="text-right">
														<div class="actions">
															...
															<a href="<?php echo base_url(); ?>admin/delete_story/<?php echo $row->id; ?>" data-value="<?php echo $row->id; ?>"  class="btn btn-danger" ><i class="far fa-trash-alt"></i></a>
														</div>
													</td>
												</tr>
											<?php $sr++; } ?>
