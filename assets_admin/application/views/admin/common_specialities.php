...
<div class="page-wrapper">
					...
					<div class="page-header">
						<div class="row">
							...
							<div class="col-sm-5 col">
								<a href="#vivek" data-toggle="modal" class="btn btn-primary float-right mt-2">Add</a> 
							</div>
						</div>
					</div>
					<?php 
			...
			<!-- Add Modal -->
			<div class="modal fade" id="vivek" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="post" action="<?php echo  base_url('admin/add_common') ?>" enctype="multipart/form-data">
			...
			<div class="modal fade" id="edit_specialities_details" aria-hidden="true" role="dialog">
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							<form method="post" action="<?php echo base_url('admin/edit_common'); ?>" enctype="multipart/form-data">
								<div class="row form-row">
								<input type="hidden" name="edit_special" id="edit_special_id" value="">
									...
									<div class="col-12 col-sm-6">
										<img style="margin-left:20px;margin-top:20px;width:100px; height:80px"  onerror="this.onerror=null; this.src='<?php echo base_url('assets/img/HOSP_icon_flat.jpg') ?>'"  id="image_view" src=""  >
									</div>
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>Image</label>
														...
														<div class="modal-dialog modal-dialog-centered" role="document" >
															...
															<!--	<div class="modal-header">
																...
																<div class="modal-body">
																	...
																	<form method="post" action="<?php echo base_url('admin/delete_commonspecialities'); ?>">
