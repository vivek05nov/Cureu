										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<?php $sr = 1; 
												...
												<tr>
													...
													<td><img src="<?php echo base_url()?>assets/img/package/<?php echo $row->image; ?>" style="width:30%; height:20%"></td>
													<?php /*<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar avatar-sm mr-2">
																<img class="avatar-img" src="<?php echo base_url(); ?>assets_admin/img/specialities/<?php echo $row->image ?>" alt="Banner">
															</a>
														</h2>
													</td> */?>
													<td class="text-right">
