...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Story</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url('admin/index'); ?>">Dashboard</a></li>
									<li class="breadcrumb-item"><a href="javascript:(0)">Story</a></li>
					...
					<div class="row">
						<div class="col-12">
							...
							<?php } ?>
									...
									<div class="card-body">
										<form action="<?php echo base_url('admin/add_story'); ?>" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label>About</label>
												<textarea class="form-control" name="about" required="" style="height: 150px;"></textarea>
				<script>
