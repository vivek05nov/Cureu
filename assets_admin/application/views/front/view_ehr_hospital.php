...
<!----Hospital Appointed EHR Section----->
	...
	<div class="col-md-7 col-lg-8 col-xl-9">
							...
							<div class="col-md-6">
								...
								<div class="card-body">
									...
									<?php } ?>
									<h4 class="card-title">EHR Send Hospital</h4>
									<div class="hotels-info">
									<form method="POST" enctype='multipart/form-data' action="<?php echo base_url('welcome/add_ehr_hospital'); ?>">  
									...
									<div class="form-group">
												...
												<?php foreach($hospital_name as $hospital): ?>
									...
									<div class="row form-row hotels-cont">
										...
										<a href="javascript:void(0);"  id="add_button1" title="Add field"><i class="fa fa-plus"></i></a>
											...
											<div class="form-group">
												<label>EHR</label>
												<input type="text" name="ehr_hospital_name[]" value="" class="form-control">
											</div>
											</div>
											...
											<div class="upload-img">  
												<div class="change-photo-btn" style="float:left;">
													...
													<input type="file" class="upload " name="hospital_image_name[]"   >
												</div><br/></br>
												<small class="form-text text-muted"> Allowed JPG, GIF , png or PNG. </small>
											</div>
											</div>
										...
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												<?php 
												 ...
												 foreach($ehr_hos_data as $row){
														$ehr_img = json_decode($row->hospital_image);
														$ehr_hospital = json_decode($row->ehr_hospital);
														echo '<td>';
														foreach($ehr_hospital as $v)
														{
													...
													echo'<td>';
														...
														foreach($ehr_img->file_name as $v)
														{ ?>
															<a style="" href="<?=base_url ()?>welcome/download_hos_ehr/<?php echo $v ?>" class="btn btn-sm"  >
