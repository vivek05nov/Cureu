...
<div class="breadcrumb-bar">
   <div class="container-fluid">
      <div class="row align-items-center">
         ...
         <div class="col-md-3 col-3 pt-3 form_div float-right">
            <form method="post" id="form_id" class="formid" action="<?php  echo base_url('welcome/search')?>">
      ...
      <div class="row">
         <div class="col-xl-8 col-md-12 m-auto order-md-last order-sm-last order-last map-left">
            <div class="row align-items-center mb-4"> 
			   ...
			   ?>
                  <h4><?php echo $doc_user_count; ?> Doctors found</h4>
               </div>
                  ...
                  <div class="doctor-widget">
                     <div class="doc-info-left">
                        <div class="doctor-img dctorPics">
                           <a href="<?php echo base_url() ?>welcome/view_profile_doctor/<?php echo $doctor->id; ?>"> 
                        ...
                        <div class="doc-info-cont">
                           <h4 class="doc-name"><a href="<?php echo base_url() ?>welcome/view_profile_doctor/<?php echo $doctor->id; ?>"><?php echo $doctor->name;?> </a></h4>
    ...
    moreText.style.display = "inline";
                     ...
                     <div class="doc-info-right">
                        ...
                        <div class="clinic-booking doctor_profle">
                           <a class="view-pro-btn" href="<?php echo base_url() ?>welcome/view_profile_doctor/<?php echo $doctor->id; ?>">View Profile</a> 
                           <?php if($this->session->userdata('username') == ''){?>
                           ...
                           <?php }
                              ...
                              {
                              	?>
                           <a class="apt-btn"  href="<?php echo base_url()?>welcome/appointment_details/<?php echo $doctor->id; ?>" data-toggle="modal" data-target="#admin">Book Appointment</a>
                           <?php 
                              }
                           ...
                           <a class="apt-btn" href="<?php echo base_url()?>welcome/appointment_details/<?php echo $doctor->id; ?>">Book Appointment</a>   
                           <?php } ?>
                        </div>
                     </div>
                  </div>
