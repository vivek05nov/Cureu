...
<div class="page-wrapper">
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="javascript:(0)">Country</a></li>
						...
						<div class="col-6">
							<!-- General -->
								<div class="card">
									...
									<?php } ?>
										<form action="<?php echo base_url(); ?>Admin/add_country" method="post">
														...
														<div class="modal-dialog modal-dialog-centered" role="document" >
															...
															<!--	<div class="modal-header">
																...
																<div class="modal-body">
																	...
																	<form method="post" action="<?php echo base_url('admin/delete_country'); ?>">
		...
		count=$('#country').val();
		 ...
		 $.ajax({url: "<?php echo base_url() ?>admin/check_country", 
				 method:"post",
				 data:{country:count},	
