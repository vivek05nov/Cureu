												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="../assets/img/hospital/<?php echo $row->doc_img; ?>" onerror="this.onerror=null; this.src='<?php echo base_url('assets/img/doctors/123.png') ?>'" alt="User Image"></a>
															<a href="#"><?php echo $row->doc_name ?> </a>
														</h2>
													</td>
														...
														<div class="modal-dialog modal-dialog-centered" role="document" >
															...
															<!--	<div class="modal-header">
																...
																<div class="modal-body">
																	...
																	<form method="post" action="<?php echo base_url('admin/delete_refer_doctor'); ?>">
