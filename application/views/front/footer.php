							...
							<div class="col-lg-2 col-md-6">
								...
								<div class="footer-widget footer-menu">
									...
									<ul class="list-group list-group-horizontal">
										...
										<li class='pr-3' ><a href="<?php echo base_url('about-us') ?>">About</a></li>

										<li class='pr-3' ><a href="<?php echo base_url('blog') ?>">Blog</a></li>

										<!--<li><a href="<?php// echo base_url('welcome/careers') ?>">Careers</a></li>--->

										<li class='pr-3'><a href="<?php echo base_url('contact-us') ?>">Contact Us</a></li>
							...
							<div class="row">
								...
								<div class="col-md-6 col-lg-6">
									...
									<div class="copyright-text">
										...
										<p class="mb-0">&copy; <?php  echo date('Y') ?> Cureu. All rights reserved.</p>
