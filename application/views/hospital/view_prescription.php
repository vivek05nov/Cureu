						...
						<div class="col-md-7 col-lg-8 col-xl-9">
							 <div class="row">
								<div class="col-md-12">
									...
									<?php } ?>
										<div class="card-body">
											<form action="<?php echo base_url(); ?>hospital/add_prescriptions" method="post" enctype="multipart/form-data">
											<div class="row">
												...
												<table   class="datatable table table-hover table-center mb-0" >
													...
													<?php $sr = 1; 
														...
														<tr>
															...
															<ul class="booking-list">
																...
																<li>
																	...
																	<?php	if(strlen($row->description) > 100){
																		...
																		<span class="read-more-content"> <?php echo substr($row->description,100,strlen($row->description));  ?>
															...
															<td class="text-center"><img src="<?php echo base_url()?>assets/img/prescriptions/<?php echo $row->file; ?>" style="width:100px; height:100px;"></td>
