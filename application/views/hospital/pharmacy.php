							...
							<div class="col-md-6">
								...
								<div class="card-body">
								  ...
								  <?php if($this->session->flashdata('success')): ?>
									...
									<form method="POST" enctype='multipart/form-data' action="<?php echo base_url('hospital/add_pharmacy'); ?>">
									...
									<div class="row form-row hotels-cont">
										...
										<a href="javascript:void(0);"  id="add_button1" title="Add field"><i class="fa fa-plus"></i></a>
											...
											<div class="form-group">
												...
												<input type="text" name="pharmacy_name[]" value="" class="form-control">
											</div>
											</div>
											...
											<div class="upload-img">  
												<div class="change-photo-btn" style="float:left;">
													...
													<input type="file" class="upload " name="userfile[]" multiple="multiple"   >
												</div><br/></br>
										...
										<table class="datatable table table-hover table-center mb-0">
											...
											foreach($pharmacy as $row){ ?>
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar avatar-sm mr-2">
																<img class="avatar-img"  src="<?php echo base_url(); ?>assets_admin/img/doctors/<?php echo $row->image ?>" onerror="this.onerror=null; this.src=''" alt="Speciality">
															</a>
													...
													<td class="text-right">
														<div class="actions">
															<a class="btn btn-sm bg-success-light" data-toggle="modal" id="edit_special" data-id="<?php echo $row->id;?>" href="#">
																<i class="fe fe-pencil"></i> Edit
															</a>
															<a  data-id="<?php echo $row->hosptial_id; ?>" data-toggle="modal" id="delete_modal" class=" delete btn btn-sm bg-danger-light "  >
